...
func Email() bool {
	...
	server.Port = 587
	server.Username = "ea99c031889297"
	server.Password = "682dacaa8e1375"
	...
	email.AddAlternative(mail.TextPlain, "This is a text/plain alternative")
	...
	// add inline
	email.Attach(&mail.File{FilePath: "/home/ack/gopher.png", Name: "Gopher.png", Inline: true})
